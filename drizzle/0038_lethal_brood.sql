...
ALTER TABLE "device_signing_keys" DROP CONSTRAINT IF EXISTS "device_signing_keys_user_id_fkey";--> statement-breakpoint
...
ALTER TABLE "invite_tokens" DROP CONSTRAINT IF EXISTS "invite_tokens_created_by_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "invite_tokens" DROP CONSTRAINT IF EXISTS "invite_tokens_used_by_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "join_requests" DROP CONSTRAINT IF EXISTS "join_requests_reviewed_by_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "key_backup_passkeys" DROP CONSTRAINT IF EXISTS "key_backup_passkeys_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "key_backups" DROP CONSTRAINT IF EXISTS "key_backups_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "poll_votes" DROP CONSTRAINT IF EXISTS "poll_votes_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "posts" DROP CONSTRAINT IF EXISTS "posts_author_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "push_prefs" DROP CONSTRAINT IF EXISTS "push_prefs_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "push_topic_mutes" DROP CONSTRAINT IF EXISTS "push_topic_mutes_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "reactions" DROP CONSTRAINT IF EXISTS "reactions_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "record_limits" DROP CONSTRAINT IF EXISTS "record_limits_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "records" DROP CONSTRAINT IF EXISTS "records_recorder_nullifier_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "tak_key_backups" DROP CONSTRAINT IF EXISTS "tak_key_backups_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "topic_archive_roots" DROP CONSTRAINT IF EXISTS "topic_archive_roots_deposited_by_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "topic_members" DROP CONSTRAINT IF EXISTS "topic_members_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "topics" DROP CONSTRAINT IF EXISTS "topics_creator_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "user_verifications" DROP CONSTRAINT IF EXISTS "user_verifications_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "votes" DROP CONSTRAINT IF EXISTS "votes_user_id_users_id_fk";--> statement-breakpoint
