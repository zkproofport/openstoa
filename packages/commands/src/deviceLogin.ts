...
//
// The full implementation is preserved verbatim below, line-commented. Uncomment
// it (strip the leading "// " from every line after this header), then re-enable:
//   - packages/commands/src/commands.ts  (deviceLogin imports, proveSpawner dep,
//     pendingGoogleLogin, loginWithGoogle, authenticateGoogle, startGoogleDeviceFlow,
//     finishGoogleLogin, GoogleLoginResult / GoogleAuthResult types)
//   - packages/commands/src/index.ts     (deviceLogin re-exports + Google* types)
//   - packages/cli/src/cli.ts            (the login --google / bare-login device path)
//   - packages/mcp/src/tools.ts          (the openstoa_authenticate tool registration)
//   - packages/commands/src/__tests__/deviceLogin.test.ts (un-skip)
//   - packages/cli/src/__tests__/cli.test.ts / packages/mcp/src/__tests__/tools.test.ts
//     (the device-flow describe.skip blocks)
...
// Keeps this file a module while the implementation above is commented out.
export {};
