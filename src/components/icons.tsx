...
export function CommentIcon({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function RecordIcon({ size = 14 }: { size?: number }) {
  // Anchor — visually distinct from share/link icons. The previous
  // chain-link glyph kept getting mistaken for a copy/share action.
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 22V8" />
...
// ─── BottomTabBar icons ──────────────────────────────────────────────────────
// Match the native app's tab bar glyphs (Feather `layers` / `hash` / `user`,
// `OpenStoaTabNavigator.tsx`) so the web mobile tab bar reads as the same
// product, not a redesign of it. `CommentIcon` above already matches the
// native `message-circle`-equivalent used elsewhere in this file (Header's
// chat toggle) and is reused for the Chat tab rather than duplicated here.
...
export function HashIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function LogInIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
