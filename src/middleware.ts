...
export async function middleware(request: NextRequest) {
  ...
  try {
    ...
    if (!guestAccessible && (pathname.startsWith('/topics') || pathname.startsWith('/api/topics') || pathname.startsWith('/api/dm') || pathname.startsWith('/api/posts') || pathname.startsWith('/api/comments') || pathname.startsWith('/api/tags') || pathname.startsWith('/api/bookmarks') || pathname.startsWith('/api/upload'))) {
